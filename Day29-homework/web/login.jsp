...
<div class="bottom">
    ...
    <div class="box">
        ...
        <form action="login" method="post">
            <input type="text" name="username" placeholder="网易云账号/网易云邮箱账号" value="<%=name %>" onfocus="inputFocus(this)" onblur="inputBlur(this)"><span id="t">请输入您的邮箱</span><br/>
            ...
            <span>还没有账号?<a href="register.html">免费注册</a></span>
